<?php
define("DATA_URL", "http://api.formater");
define("DATA_FILE", __DIR__."/data/geojosn_observaties_lc.json");
// ftp connexion
...
function search_infos(&$obs, $code, $dataType){
    ...
    if($list1 != false){
        ...
        $obs->api->url = DATA_URL."/cds/bcmt/data/".strtolower($code);
        $obs->api->name = "BCMT";
...
ftp_close($conn_id);
    file_put_contents(DATA_FILE,json_encode( $result, JSON_NUMERIC_CHECK) );
